...
static responser2 res2_instance;
 ...
 int main(void)
 {
 	...
 	while(1){
		 ...
		 LOGOUT_NOTICE("#### send msg to RES1 hope to execute r1_fun1()\n");
		 ...
		 LOGOUT_NOTICE("#### send msg to RES1 hope to execute r1_fun2()\n");
		 ...
		 LOGOUT_NOTICE("#### send msg to RES2 hope to execute r2_fun1()\n");
		 ...
		 LOGOUT_NOTICE("#### send msg to RES2 hope to execute r2_fun2()\n");
